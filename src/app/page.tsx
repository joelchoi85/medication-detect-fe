  ...
  return (
    <main id="main-content" className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 px-6 py-12">
      <header className="flex flex-col gap-2">
        ...
        <h3 className="mt-4 text-center font-bold underline underline-offset-4 text-white/30">
          <Link
            href="/team"
            className="transition-colors hover:text-white/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
          >
            Part2 Mission - 3 TEAM
          </Link>
        </h3>
        <p className="mt-16 text-sm text-foreground/60">
          알약 사진을 업로드하면 AI가 종류와 위치를 검출해 이미지 위에 표시합니다.
          <br/>
          현재는 <u>테스트 데이터셋의 이미지까지만</u> 원활하게 검출이 됩니다!
          <br/>
          동시접속자 수가 많아지면 시스템이 불안정할 수도 있습니다.
        </p>
      </header>
      <PillDetector />
      <footer className="mt-auto pt-8 border-t border-white/10 text-center text-xs text-foreground/40" title="3팀-이태민,이형기,장한빈,최중열,홍우석">
